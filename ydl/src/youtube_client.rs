...
impl ClientType {
    ...
    fn user_agent(&self) -> &str {
        match self {
            ClientType::Web => "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",
            ClientType::TvEmbedded => "Mozilla/5.0 (PlayStation 4 5.55) AppleWebKit/601.2 (KHTML, like Gecko)",
            ClientType::Ios => "com.google.ios.youtube/19.29.1 (iPhone16,2; U; CPU iOS 17_5_1 like Mac OS X;)",
            ClientType::Android => "com.google.android.youtube/19.29.37 (Linux; U; Android 14; en_US; Pixel 7 Pro)",
        }
    }
}
